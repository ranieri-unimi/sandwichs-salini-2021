---
title: "Bootstrap example independent sample"
...
Number of books read in March and April by children who, during the quarantine, used a parent-owned tablet for school activities (Own tablet = No)
...
Number of books read in March and April by children who, during the quarantine, used a tabelt of their exclusive use for school activities (Own tablet = Yes)
```{r}
